...
run_case "all read scenarios, 1M, 1 series" \
    --points 1000000 --series 1 --scenario all --repeat 5

run_case "full range read, 1M, 6 series" \
    --points 1000000 --series 6 --scenario read_range_full --repeat 5

run_case "full AVG aggregate, 1M, 6 series" \
    --points 1000000 --series 6 --scenario aggregate_avg_full --repeat 5
